...
<body>
   <input type="hidden" value='<?php echo $_GET["screen"]; ?>' id="screen_Id" name="screen_Id">
<!--    <input type="hidden" value='/php/' id="screen_no">-->
    <input type="hidden" value='<?php echo $_GET["time"]; ?>' id="time" name="time">
    <input type="hidden" value='<?php echo $_GET["date"]; ?>' id="date" name="date">
